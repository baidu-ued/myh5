...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(global, factory) {
		 true ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global.VuePagination = factory());
	}(this, (function() {
		'use strict';
		return {
			template: '<div><ul><li @click="select(1)" :class="{disabled:activePage == 1}">第一页</li><li @click="select(activePage - 1)" :class="{disabled:activePage == 1}">prev</li><li @click="select(i)" :class="{actived:activePage==i,disabled: index+1==activePage }"  v-for="(i, index) in list">{{i}}</li><li @click="select(activePage + 1)" :class="{disabled:activePage == pageLength}">next</li><li @click="select(pageLength)" :class="{disabled:activePage == pageLength}">最后一页</li></ul></div>',
			props: {
				pageLength: {
					type: Number,
					required: true,
			...
			computed: {
				...
				list: function() {
					...
					if (this.activePage <= this.halfSize) {
						// console.log()( (v, k) => { return  ((this.pageLength - this.pageSize) > 0 ? (this.pageLength - this.pageSize) : 0)} + (k + 1)
...
//# sourceMappingURL=vendor.7c1abf9b0b9ffbc70aeb.js.map